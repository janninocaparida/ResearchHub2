...
class CustomAdminSite(admin.AdminSite):
    """Custom admin site with enhanced branding and navigation"""
    site_header = "ResearchHub Administration"
    site_title = "ResearchHub Admin"
    index_title = "Welcome to ResearchHub Admin Portal"
    
    def index(self, request, extra_context=None):
        """Add custom context to admin index page"""
        extra_context = extra_context or {}
        extra_context['students_management_url'] = reverse('home')
...
class StudentsAdmin(admin.ModelAdmin):
    ...
    list_display = ['student_id_display', 'student_name_display', 'department_display', 
                    'created_date_display', 'updated_date_display', 'record_status', 'student_page_link']
    ...
    def student_page_link(self, obj):
        """Display link to view student on management page"""
        return format_html(
            '<a href="{}#student-{}" style="background-color: #1976d2; color: white; padding: 5px 10px; border-radius: 5px; text-decoration: none; font-weight: bold; display: inline-block;">📄 View Page</a>',
            reverse('home'),
            obj.id
        )
    student_page_link.short_description = 'Public Page'
